...
const Quiz = (function () {
  ...
  const MOCK_BOARD_KEYS = [
    ...
    { key: 'MOCK_BOARD_GEAS', label: 'Mock Board - GEAS' },
    { key: 'MOCK_BOARD_EST_OCT_2024', label: 'Mock Board - EST (Oct 2024)' }
  ];
  ...
  function renderExamCategoryCheckboxes() {
    ...
    // Use MOCK_BOARD_KEYS directly to avoid duplication and ReferenceErrors
    createExamSection('Mock Board Exams', MOCK_BOARD_KEYS);
  }
